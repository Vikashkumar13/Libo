...
function Signup() {
  ...
  const onSubmit = async (data) => {
    ...
    await axios.post("http://localhost:8000/user/signup", userInfo).then((res) => {
            ...
            <form onSubmit={handleSubmit(onSubmit)} method="dialog">
              ...
              <div className="mt-4 space-y-2">
                ...
                <input type="text" placeholder="Enter your fullname"
                  className="w-80 px-3 py-1 border rounded-md outline-none" {...register("fullname", { required: true })}
                />
                <br />
